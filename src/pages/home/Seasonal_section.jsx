...
function Seasonal_section() {
  ...
  return (
<Box sx={{ bgcolor: 'background', color: '#ffffff', py: 8, px: 2, minHeight: '100vh' }}>
      <Container maxWidth="lg">
            ...
            >
              ...
              <Stack spacing={2.5} sx={{ mb: 4 }}>
                <Stack direction="row" spacing={2} sx={{alignItems:"center"}}>
                  ...
                  <Box>
                    <Typography variant="caption" display="block" sx={{ color: '#a1a1aa', fontSize: '0.7rem', fontWeight: 600, letterSpacing: 0.5 }}>
                      FREQUENCY RESPONSE
                    </Typography>
        ...
        <Grid container spacing={3} justifyContent="space-between" sx={{pt:"40px"}}>
  ...
  <Grid size={{ xs: 12, sm: 4 }}>
    <Stack direction="row" spacing={2} alignItems="center">
      ...
      <Box>
        <Typography  sx={{fontSize:"24px" ,fontWeight: 600, color:"h2color"}}>
  ...
  <Grid size={{ xs: 12, sm: 4 }}>
    <Stack direction="row" spacing={2} alignItems="center">
      ...
      <Box>
        ...
        <Typography variant="caption" sx={{ fontSize:"14px",color: "#71717a" }}>
